...
The DIT is defined by the `nmd_openldap/dit` data bag item if it exists, otherwise by the `node.nmd_openldap.dit` attribute.
...
Example of `nmd_openldap/populate` data bag item:
